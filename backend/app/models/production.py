...
class FeatureMatrix(SQLModel, table=True):
    ...
    # snap_pct_off: offensive snap participation rate (0-1) for the target game.
    # Audit C-01: this leaked the game being predicted and is written NULL since
    # the session-02 feature-contract rebuild. Retained as a column so historical
    # rows keep their shape; not a model feature.
    snap_pct_off: Optional[float] = None
    # prior_snap_share: snap fraction from the player's last *completed* game —
    # the pregame-knowable replacement for snap_pct_off.
    ...
    player_emb_8: Optional[float] = None
    player_emb_9: Optional[float] = None
    player_emb_10: Optional[float] = None
    player_emb_11: Optional[float] = None
    player_emb_12: Optional[float] = None
    player_emb_13: Optional[float] = None
    player_emb_14: Optional[float] = None
    player_emb_15: Optional[float] = None
    player_emb_16: Optional[float] = None
    player_emb_17: Optional[float] = None
    player_emb_18: Optional[float] = None
    player_emb_19: Optional[float] = None
    player_emb_20: Optional[float] = None
    player_emb_21: Optional[float] = None
    player_emb_22: Optional[float] = None
    player_emb_23: Optional[float] = None
    player_emb_24: Optional[float] = None
    player_emb_25: Optional[float] = None
    player_emb_26: Optional[float] = None
    player_emb_27: Optional[float] = None
    player_emb_28: Optional[float] = None
    player_emb_29: Optional[float] = None
    player_emb_30: Optional[float] = None
    player_emb_31: Optional[float] = None
    routes_run_per_game: Optional[float] = None
    prior_epa_per_play: Optional[float] = None
    prior_epa_per_target: Optional[float] = None
    prior_epa_per_rush: Optional[float] = None
    prior_qb_epa_per_dropback: Optional[float] = None
    prior_adot: Optional[float] = None
    prior_drop_rate: Optional[float] = None
    prior_avg_separation: Optional[float] = None
    prior_avg_cushion: Optional[float] = None
    prior_target_share_pbp: Optional[float] = None
    prior_air_yards_share_pbp: Optional[float] = None
    prior_red_zone_targets: Optional[float] = None
    prior_end_zone_targets: Optional[float] = None
    prior_red_zone_target_share: Optional[float] = None
    prior_pass_left_rate: Optional[float] = None
    prior_pass_middle_rate: Optional[float] = None
    prior_pass_right_rate: Optional[float] = None
    prior_ol_pressure_rate: Optional[float] = None
    prior_ol_sack_rate: Optional[float] = None
    prior_yac_per_reception: Optional[float] = None
    prior_xyac_per_reception: Optional[float] = None
    slot_rate: Optional[float] = None
